...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='../datasets/Middlebury', split='H'):
        ...
        if split == "2014": # datasets/Middlebury/2014/Pipes-perfect/im0.png
            ...
            #lines = list(filter(lambda p: any(s in p.split('/') for s in Path(os.path.join(root, "MiddEval3/trainingH/Adirondack/calib.txt")).read_text().splitlines()), lines))
