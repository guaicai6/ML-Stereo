...
def train(args):
    ...
    model = nn.DataParallel(MLStereo(args), device_ids=[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='ml-stereo', help="name your experiment")
    ...
    parser.add_argument('--num_steps', type=int, default=550000, help="length of training schedule.")
